import {getFullTestById, updateTest} from "../../../../../services/drkb-wiki-education/TestService";
...
const CreateArticleModal = ({open, onClose}) => {
    ...
    const handleSaveTest = async () => {
        console.log(createTestModel);
        const response = await updateTest(createTestModel);
        if (response.success) {
                ...
                <div className="admin-test">
                   ...
                   {/* <ErrorSnackbar onClose={() => setErrorTest(null)} message={errorTest} />*/}
                        ...
                        <input
                            ...
                            onChange={(e) => setCreateTestModel(prev => ({ ...prev, totalPointsRequired: parseInt(e.target.value) }))}
                            required
                        />
                        ...
                        <input
                            ...
                            onChange={(e) => setCreateTestModel(prev => ({ ...prev, numberOfTries: parseInt(e.target.value) }))}
                            required
                        />
                        ...
                        <input
                            ...
                            onChange={(e) => setCreateTestModel(prev => ({ ...prev, numberOfQuestions: parseInt(e.target.value) }))}
                            required
                        />
